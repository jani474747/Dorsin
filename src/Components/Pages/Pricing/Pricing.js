      ...
      <div className='pricing'>
        ...
        <div className='pricing-two'>
          ...
          <div className='pricing-two-2'>
            ...
            <h6>BILLING PER MONTH</h6>
            <hr/>
            <p className="p1">Bandwidth: <b>10GB</b></p>
            <p className="p2">Onlinespace : <b>500MB</b></p>
            <p className="p3">Support: <b>Yes</b></p>
            <p className="p4">Domain: <b>10</b></p>
            <p className="p5">Hidden Fees: <b>No</b></p>
            <a href="#">Join Now</a>
          </div>
          <div className='pricing-two-2'>
            ...
            <h6>BILLING PER MONTH</h6>
            <hr/>
            <p className="p1">Bandwidth: <b>100GB</b></p>
            <p className="p2">Onlinespace : <b>2GB</b></p>
            <p className="p3">Support: <b>Yes</b></p>
            <p className="p4">Domain: <b>unlimited</b></p>
            <p className="p5">Hidden Fees: <b>No</b></p>
            <a href="#">Join Now</a>
          </div>
        </div>
